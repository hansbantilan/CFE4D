...
c----------------------------------------------------------------------
     ...
     &                       background,kappa_cd,rho_cd)
        ...
        !--------------------------------------------------------------
        real*8 d0_llll(4,4,4,4)
        real*8 d0_llll_x(4,4,4,4,4),d0_llll_xx(4,4,4,4,4,4)
        ...
        data d0_llll/256*0/
        data d0_llll_x,d0_llll_xx/1024*0,4096*0/
     ...
     &                set_ll(3,4)*g0_uu(3,4))
              ...
              do a=1,4
                do b=a,4
                  ...
                  cfe(a,b)=0 !TMP!
!     &                     term1(a,b)+term2(a,b)+term3(a,b)+term4(a,b)

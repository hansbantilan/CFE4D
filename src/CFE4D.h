...
void g_evo_opt_(real *db_res, real *gb_res, real *kg_res, real *cl_res,
                real *db_txtx_np1, real *db_txtx_n, real *db_txtx_nm1,
                real *db_txty_np1, real *db_txty_n, real *db_txty_nm1,
                real *db_txtz_np1, real *db_txtz_n, real *db_txtz_nm1,
                real *db_txxy_np1, real *db_txxy_n, real *db_txxy_nm1,
                real *db_txxz_np1, real *db_txxz_n, real *db_txxz_nm1,
                real *db_txyz_np1, real *db_txyz_n, real *db_txyz_nm1,
                real *db_tyty_np1, real *db_tyty_n, real *db_tyty_nm1,
                real *db_tytz_np1, real *db_tytz_n, real *db_tytz_nm1,
                real *db_tyxy_np1, real *db_tyxy_n, real *db_tyxy_nm1,
                real *db_tyxz_np1, real *db_tyxz_n, real *db_tyxz_nm1,
                real *db_tyyz_np1, real *db_tyyz_n, real *db_tyyz_nm1,
                real *db_tztz_np1, real *db_tztz_n, real *db_tztz_nm1,
                real *db_tzxy_np1, real *db_tzxy_n, real *db_tzxy_nm1,
                real *db_tzxz_np1, real *db_tzxz_n, real *db_tzxz_nm1,
                real *db_tzyz_np1, real *db_tzyz_n, real *db_tzyz_nm1,
                real *db_xyxy_np1, real *db_xyxy_n, real *db_xyxy_nm1,
                real *db_xyxz_np1, real *db_xyxz_n, real *db_xyxz_nm1,
                real *db_xyyz_np1, real *db_xyyz_n, real *db_xyyz_nm1,
                real *db_xzxz_np1, real *db_xzxz_n, real *db_xzxz_nm1,
                real *db_xzyz_np1, real *db_xzyz_n, real *db_xzyz_nm1,
                real *db_yzyz_np1, real *db_yzyz_n, real *db_yzyz_nm1,

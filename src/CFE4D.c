//============================================================================
// in polar coordinates t,x,theta,phi for x in [0,1]
...
real *db_tttt,*db_tttt_n,*db_tttt_np1,*db_tttt_nm1;
real *db_tttx,*db_tttx_n,*db_tttx_np1,*db_tttx_nm1;
real *db_tttp,*db_tttp_n,*db_tttp_np1,*db_tttp_nm1;
real *db_ttxx,*db_ttxx_n,*db_ttxx_np1,*db_ttxx_nm1;
real *db_ttxp,*db_ttxp_n,*db_ttxp_np1,*db_ttxp_nm1;
real *db_txtx,*db_txtx_n,*db_txtx_np1,*db_txtx_nm1;
real *db_txtp,*db_txtp_n,*db_txtp_np1,*db_txtp_nm1;
real *db_txxx,*db_txxx_n,*db_txxx_np1,*db_txxx_nm1;
real *db_txxp,*db_txxp_n,*db_txxp_np1,*db_txxp_nm1;
real *db_tptp,*db_tptp_n,*db_tptp_np1,*db_tptp_nm1;
real *db_tpxp,*db_tpxp_n,*db_tpxp_np1,*db_tpxp_nm1;
real *db_tppp,*db_tppp_n,*db_tppp_np1,*db_tppp_nm1;
real *db_xxxx,*db_xxxx_n,*db_xxxx_np1,*db_xxxx_nm1;
real *db_xxxp,*db_xxxp_n,*db_xxxp_np1,*db_xxxp_nm1;
real *db_xpxp,*db_xpxp_n,*db_xpxp_np1,*db_xpxp_nm1;
real *db_xppp,*db_xppp_n,*db_xppp_np1,*db_xppp_nm1;
real *db_tttt_t,*db_tttt_t_n;
real *db_tttx_t,*db_tttx_t_n;
real *db_tttp_t,*db_tttp_t_n;
real *db_ttxx_t,*db_ttxx_t_n;
real *db_ttxp_t,*db_ttxp_t_n;
real *db_txtx_t,*db_txtx_t_n;
real *db_txtp_t,*db_txtp_t_n;
real *db_txxx_t,*db_txxx_t_n;
real *db_txxp_t,*db_txxp_t_n;
real *db_tptp_t,*db_tptp_t_n;
real *db_tpxp_t,*db_tpxp_t_n;
real *db_tppp_t,*db_tppp_t_n;
real *db_xxxx_t,*db_xxxx_t_n;
real *db_xxxp_t,*db_xxxp_t_n;
real *db_xpxp_t,*db_xpxp_t_n;
real *db_xppp_t,*db_xppp_t_n;
real *db_res;
